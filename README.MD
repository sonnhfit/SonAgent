...
[x] plannning and save plan to db and
[] load skill from user_data folder 
[] planning for learning skill for learn new skill
[] auto create pull request for add new skill
