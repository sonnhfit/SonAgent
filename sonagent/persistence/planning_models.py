...
class Task(ModelBase):
    ...
    artifacts: Mapped[List[Artifact]] = mapped_column(Artifact, nullable=True)
    steps: Mapped[List["Step"]] = mapped_column("Step", nullable=True)
    description: Mapped[str] = mapped_column(String, nullable=True)
    created_at: Mapped[str] = mapped_column(
        String, nullable=True, default=dt_now)
